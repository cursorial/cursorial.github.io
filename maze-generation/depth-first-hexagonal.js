...
var depthFirstHexagonalSketch = function(p) {
    ...
    p.draw = function() {
        ...
        if (currentCell) {
            for (var neighbour of findNeighboursHexGrid(
                grid,
                currentCell.x,
                currentCell.y
            )) {
            ...
            if (unvisitedNeighbours.length > 0) {
                ...
                if (currentCell.x % 2 == 0) {
                    if (dx == 1 && dy == 0) {
                        currentCell.walls.splice(
                            currentCell.walls.indexOf("top-right"),
                            1
                        );
                        neighbourCell.walls.splice(
                            neighbourCell.walls.indexOf("bottom-left"),
                            1
                        );
                    }
                    if (dx == 1 && dy == 1) {
                        currentCell.walls.splice(
                            currentCell.walls.indexOf("bottom-right"),
                            1
                        );
                        neighbourCell.walls.splice(
                            neighbourCell.walls.indexOf("top-left"),
                            1
                        );
                    }
                    if (dx == -1 && dy == 0) {
                        currentCell.walls.splice(
                            currentCell.walls.indexOf("top-left"),
                            1
                        );
                        neighbourCell.walls.splice(
                            neighbourCell.walls.indexOf("bottom-right"),
                            1
                        );
                    }
                    if (dx == -1 && dy == 1) {
                        currentCell.walls.splice(
                            currentCell.walls.indexOf("bottom-left"),
                            1
                        );
                        neighbourCell.walls.splice(
                            neighbourCell.walls.indexOf("top-right"),
                            1
                        );
                    }
                } else {
                ...
                if (dx == 0 && dy == -1) {
                    currentCell.walls.splice(
                        currentCell.walls.indexOf("top"),
                        1
                    );
                    neighbourCell.walls.splice(
                        neighbourCell.walls.indexOf("bottom"),
                        1
                    );
                }
                if (dx == 0 && dy == 1) {
                    currentCell.walls.splice(
                        currentCell.walls.indexOf("bottom"),
                        1
                    );
                    neighbourCell.walls.splice(
                        neighbourCell.walls.indexOf("top"),
                        1
                    );
                }
...
new p5(
    depthFirstHexagonalSketch,
    document.getElementById("depth-first-sketch-hexagonal")
);
